...
- [ ] Archive completed work to Obsidian with conversation basis, summary, changed files, reason, verification, user reflection prompts, risks, next work, and Git commit hash plus Korean/English title.
