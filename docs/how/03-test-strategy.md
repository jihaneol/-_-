...
- Keep admin web slice tests in the `admin-api` module.
- Keep shop web slice tests in the `shop-api` module.
...
- Keep full Spring Boot context tests in the `admin-api` and `shop-api` modules.
