package com.example.cardservice.domain.commerce.model.projection
...
@Table(
    name = "payment_operational_projections",
    uniqueConstraints = [
        UniqueConstraint(
            name = "uk_payment_operational_projection_operation_order",
            columnNames = ["operation_type", "order_id"],
        ),
    ],
)
class PaymentOperationalProjection protected constructor() {
    @Id
    ...
    var operationType: PaymentOperationalProjectionType = PaymentOperationalProjectionType.PAYMENT_AUTHORIZED
        protected set
    ...
    private constructor(
        operationType: PaymentOperationalProjectionType,
        orderId: Long,
        paymentId: Long,
        memberId: Long,
        amount: Long,
    ...
    companion object {
        fun paymentAuthorized(
            ...
            PaymentOperationalProjection(
                operationType = PaymentOperationalProjectionType.PAYMENT_AUTHORIZED,
                orderId = orderId,
                paymentId = paymentId,
                memberId = memberId,
                amount = amount,
        ...
        fun paymentRefunded(
            ...
            PaymentOperationalProjection(
                operationType = PaymentOperationalProjectionType.PAYMENT_REFUNDED,
                orderId = orderId,
                paymentId = paymentId,
                memberId = memberId,
                amount = amount,
...
enum class PaymentOperationalProjectionType {
    PAYMENT_AUTHORIZED,
    PAYMENT_REFUNDED,
}
