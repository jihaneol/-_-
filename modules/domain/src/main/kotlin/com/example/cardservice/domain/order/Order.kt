...
class Order protected constructor() {
    ...
    private val mutableLines: MutableList<OrderItem> = mutableListOf()

    val lines: List<OrderItem>
        get() = mutableLines.toList()

    private constructor(memberId: Long, lines: List<OrderItem>) : this() {
    ...
    companion object {
        fun create(memberId: Long, lines: List<OrderItem>): Order = Order(memberId, lines)
    }
}
